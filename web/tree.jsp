...
var treeMenu = [
	{ level:1, name:"通知单取号管理"},
	{ level:2, name:"通知单编号列表", ico:"images/icon_default.gif",link:"/QueryAllTZD.action"},
	{ level:1, name:"机规取号管理"},
	{ level:2, name:"机规编号列表", ico:"images/icon_default.gif",link:"role_list.html"},
	{ level:1, name:"传真取号管理"},
	{ level:2, name:"传真编号列表", ico:"images/icon_default.gif",link:"news_list.html"},
	{ level:1, name:"BUG反馈", ico:"images/icon_default.gif"},
